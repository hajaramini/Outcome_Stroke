...
threehrsubtractfivehr_sort <- threehrsubtractfivehr[order(rownames(threehrsubtractfivehr)),] #50 54675
...
DS_GE_threehrsubtractfivehr <- merge( data, data2, by="names")


merge(DS_Demographic,DS_GE_threehrsubtractfivehr, sort = TRUE)

VS_Demographic_all <- Demographic_all_sort[rownames(Demographic_all_sort)%in%VS_Filename_v2,] #11 443

DS_GE_threehrsubtractfivehr
