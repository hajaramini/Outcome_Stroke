...
```{r}
#Plot for MMP11, MMP14, IL-27 for Model 76 (HGS Presentation)

Model76_small <- read.delim("C:/Outcome/Partek_Analysis/New/Model76_RemoveBatch_10-21-20.txt", header=TRUE, row.names=1)
```

```{r}
y <- ggplot(Model76_small, aes(x=Model76_small$BaseSubtract90day_Improvement, y=Model76_small$X1552995_at, color = Model76_small$Gender)) + 
  geom_point(size =3)+
  geom_smooth(method=lm, se=FALSE, color="black")
