...
Filename_v2 <- read.csv("C:/Outcome/R_Outcome_Stroke/Input_Output/50_Outcome_Filename_03-04-20.csv", header=T) #all 50 samples for outcome project
...
merge_5hr_v2 <- merge_5hr[x,] #50 54685
...
##fivehrsubtracttwentyfourhr <- merge_v3_5hr_v2[,c(18:54692)] - merge_v3_24hr_v2[,c(18:54692)] #50 54675 keep 5hr rowname for subtrac
...
```{r}
#save
write.csv(Demographic_all_sort,file = "../../Input_Output/36_Demographic_Parameter_All_03-16-20.csv")
```
...
load( "../Input_Output/RData/3hrSubtract5hr_GE_03-04-20.RData") 
...
DS_GE_threehrsubtractfivehr <- merge( data, data2, by="names") # 25 55139

#save
write.csv(DS_GE_threehrsubtractfivehr,file = "../../Input_Output/25_Demographic_Parameter_GE_threehrsubtractfivehr_03-19-20.csv")
save(DS_GE_threehrsubtractfivehr,file = "../../Input_Output/RData/25_Demographic_Parameter_GE_threehrsubtractfivehr.RData")
```


```{r}
#load files including subtract for the GE threehrsubtracttwentyfourhr
load(file = "../../Input_Output/RData/3hrSubtract24hr_GE_03-04-20.RData")
...
DS_GE_threehrsubtracttwentyfourhr <- merge(data, data2, by="names") # 25 55139

#save
write.csv(DS_GE_threehrsubtracttwentyfourhr,file = "../../Input_Output/25_Demographic_Parameter_GE_threehrsubtracttwentyfourhr_03-20-20.csv")
save(DS_GE_threehrsubtracttwentyfourhr,file = "../../Input_Output/RData/25_Demographic_Parameter_GE_threehrsubtracttwentyfourhr.RData")
...
load(file = "../../Input_Output/RData/5hrSubtract24hr_GE_03-04-20.RData")
...
DS_GE_fivehrsubtracttwentyfourhr <- merge(data, data2, by="names") # 25 55139

#save
write.csv(DS_GE_fivehrsubtracttwentyfourhr,file = "../../Input_Output/25_Demographic_Parameter_DS_GE_fivehrsubtracttwentyfourhr_03-20-20.csv")
save(DS_GE_fivehrsubtracttwentyfourhr,file = "../../Input_Output/RData/25_Demographic_Parameter_GE_fivehrsubtracttwentyfourhr.RData")
```
...
#3hr
load(file = "../../Input_Output/RData/50_Demographic_GE_3hr_03-02-20.RData")
merge_v3_3hr_v2 %>% dim() #50 54692

x <- rownames(DS_Demographic)
DS_GE_threehr <- merge_v3_3hr_v2[rownames(merge_v3_3hr_v2)%in%x,] #25 54692 
#d <- DS_Demographic
#names <- rownames(d)
#rownames(d) <- NULL
#data <- cbind(names,d) #25 464
...
DS_GE_threehr <- merge(data, data2, by="names") # 25 55156 (x, y in suffix for two files) #55156

#save
write.csv(DS_GE_threehr,file = "../../Input_Output/25_Demographic_Parameter_GE_threehr_03-20-20.csv")
save(DS_GE_threehr,file = "../../Input_Output/RData/25_Demographic_Parameter_GE_threehr.RData")
```

```{r}
#5hr
load(file = "../../Input_Output/RData/50_Demographic_GE_5hr_03-02-20.RData")
merge_v3_5hr_v2 %>% dim() #50 54692

#x <- rownames(DS_Demographic)

#keep the filename of all files same as three hour with "-B-" and "-0-"

y <- c("105-2-4_HGU133_Plus_2.CEL","112-2-1_HGU133_Plus_2.CEL","201-2-4_HGU133_Plus_2.CEL", "210-2-1_HGU133_Plus_2.CEL","225-2-2_HGU133_Plus_2.CEL","236-2-1_HGU133_Plus_2.CEL" , "255-2-5_HGU133_Plus_2.CEL","261-2-1_HGU133_Plus_2.CEL"      "262-2-4_HGU133_Plus_2.CEL" ,  "278-2-4_HGU133_Plus_2.CEL", "279-2-2_HGU133_Plus_2.CEL" "287-2-4_HGU133_Plus_2.CEL"      "289-2-5_HGU133_Plus_2.CEL" "CL102-2-5_HGU133_Plus_2.CEL"    "CL104-2-4_HGU133_Plus_2.CEL", "CL130-2-1_HGU133_Plus_2.CEL"    "CL131-2-1_HGU133_Plus_2.CEL"   
"CL132-2-3_HGU133_Plus_2.CEL", "CL135-2-6_HGU133_Plus_2.CEL"  "CL138-2-2_HGU133_Plus_2.CEL"    "CL150-2-3_HGU133_Plus_2.CEL"   ")
y <- DS_GE_threehr$names
DS_GE_fivehr <- merge_v3_5hr_v2[y, ] #25 54692 
#d <- DS_Demographic
#names <- rownames(d)
#rownames(d) <- NULL
#data <- cbind(names,d) #25 464
